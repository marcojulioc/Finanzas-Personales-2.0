...
CREATE TABLE "CreditCard" (
    ...
    "name" VARCHAR(50) NOT NULL,
    "bankName" VARCHAR(50) NOT NULL,
    "cutOffDay" SMALLINT NOT NULL,
    "paymentDueDay" SMALLINT NOT NULL,
    "limitMXN" DECIMAL(12,2) NOT NULL,
    "limitUSD" DECIMAL(12,2) NOT NULL,
    "balanceMXN" DECIMAL(12,2) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Transaction" ADD CONSTRAINT "Transaction_targetCardId_fkey" FOREIGN KEY ("targetCardId") REFERENCES "CreditCard"("id") ON DELETE SET NULL ON UPDATE CASCADE;
